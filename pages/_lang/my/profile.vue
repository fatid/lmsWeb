<template>
    <div class="sa4d25">
			<div class="container-fluid">			
				<div class="row">
					<div class="col-lg-12">
						<h2 class="st_title"><i class="uil uil-cog"></i> {{l('Settings','general')}}</h2>
						<div class="setting_tabs">
							<ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
								...
								<li class="nav-item">
                                    ...
                                    >{{l('Notification','general')}} </a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="pills-privacy-tab"  
                                       @click="show='privacy'"
                                            :class="show=='privacy' ? 'active':''" >{{l('Privacy','general')}}  </a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="pills-bllingpayment-tab" 
                                     @click="show='bllingpayment'"
                                            :class="show=='bllingpayment' ? 'active':''" 
                                    >{{l('Billing and Payouts','general')}} </a>
								</li>
                             ...
                             >
                              ...
                              <b-alert  :show="saveStatus.show" dismissible :variant="saveStatus.status">
								...
								<div class="account_setting">
									<h4>{{l('Change Your Account Information','g')}}</h4>
														...
														<div class="col-lg-6">
															<div class="ui search focus mt-30">
																<div class="ui left icon input swdh11 swdh19">
																	<input class="prompt srch_explore" type="text" name="name" v-model="myProfile.U_rname"  placeholder="First Name">															
																</div>
															</div>
														</div>
														<div class="col-lg-6">
															<div class="ui search focus mt-30">
																<div class="ui left icon input swdh11 swdh19">
																	<input class="prompt srch_explore" type="text" name="surname" v-model="myProfile.U_surname"    placeholder="Last Name">															
																</div>
															</div>
														</div>
														<div class="col-lg-12">
															<div class="ui search focus mt-30">
																<div class="ui left icon input swdh11 swdh19">
																	<input class="prompt srch_explore" type="text" name="headline" v-model="myProfile.U_headline" id="id_headline" required="" maxlength="60" placeholder="Headline">															
									...
									<button class="save_btn" type="submit" @click="saveProfile()">{{l('Save Changes','general')}}</button>
								</div>
							</div>
							<div class="tab-pane fade" 
									...
									<div class="basic_profile">										
										<div class="basic_form">
											<div class="nstting_content">
												...
												<div class="ui toggle checkbox _1457s2">
													<input type="checkbox" name="stream_ss5" checked="" tabindex="0" class="hidden">
												...
												<div class="ui toggle checkbox _1457s2">
													<input type="checkbox" name="stream_ss6" tabindex="0" class="hidden">
													<label>Promotions, course recommendations, and helpful resources from Cursus.</label>
												</div>
												<div class="ui toggle checkbox _1457s2">
													<input type="checkbox" name="stream_ss7" tabindex="0" class="hidden">
									...
									<div class="basic_profile">										
										<div class="basic_form">
											<div class="nstting_content">
												...
												<div class="ui toggle checkbox _1457s2">
													<input type="checkbox" name="stream_ss8" checked="" tabindex="0" class="hidden">
													<label>Show your profile on search engines</label>
												</div>
												<div class="ui toggle checkbox _1457s2">
													<input type="checkbox" name="stream_ss9" tabindex="0" class="hidden">
