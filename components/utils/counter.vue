      ...
      >
        ...
        >
          ...
          <circle
            ...
            :style="{
              strokeDasharray: stroke_dasharray_hour,
              strokeDashoffset: stroke_dashoffset_hour
            }"
      ...
      >
        ...
        >
          ...
          <circle
            :transform="'rotate(-90, ' + cx + ', ' + cy + ')'"
            :style="{
              strokeDasharray: stroke_dasharray_minute,
              strokeDashoffset: stroke_dashoffset_minute
            }"
            class="circle_animation"
            :r="r"
            :cy="cx"
      ...
      >
        ...
        >
          ...
          <circle
            :transform="'rotate(-90, ' + cx + ', ' + cy + ')'"
            :style="{
              strokeDasharray: stroke_dasharray_second,
              strokeDashoffset: stroke_dashoffset_second
            }"
            class="circle_animation"
            :r="r"
            :cy="cx"
